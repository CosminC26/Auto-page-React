...
const Appointment = () => {
  return (
    <section id="appointment" className='bg-yellow-secondary py-12 lg:pb-12 lg:mt-32 relative min-h-[584px]'>
      <div className='container mx-auto'>
        <div>
          ...
          <form className='bg-yellow py-8 px-6 w-full max-w-[790px] h-[500px] mx-auto lg:-mt-5 rounded-[60px] text-center flex flex-col justify-start items-center gap-y-4' >
            ...
            <input className='input-control' type="text" placeholder='FullName' />
            <input className='input-control' type="text" placeholder='Email Adress' />
